...
#                     cv2.circle(img, (x, y), 1, (0, 0, 255), -1)
        ...
        print("EyeClose:{0}".format(each_close_counter))
        ...
        all_close_counter+=each_close_counter
        
      
print('-'*20)
print("all_Blink_Counter:{0}".format(all_blink_counter)) 
print("all_close_counter:{0}".format(all_close_counter)) 
